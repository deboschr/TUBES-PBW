...
public class UserController {
   ...
   public String renderSignupPage() {
      return "signup"; // View template di templates/signup.html
   }

   // Render halaman signin
   @GetMapping("/signin")
   public String renderSigninPage() {
      return "signin"; // View template di templates/signin.html
   }
   ...
   public String renderProfilePage(HttpSession session, Model model) {
      ...
      return "profile"; // View template di templates/profile.html
   }
